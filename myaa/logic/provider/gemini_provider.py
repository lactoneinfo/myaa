...
from myaa.logic.provider.base import LLMProvider
...
class GeminiProvider(LLMProvider):
    ...
    async def chat(self, messages: LLMPrompt, character_name: str) -> Message:
        ...
        return Message(speaker=character_name, content=content)
